...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    // COMPLETED (2) Within that interface, define a void method that accepts a String as a parameter
    interface  ForecastAdapterOnClickHandler {
        void onForecastAdapterClick(String in_line);
    }
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
           mClickHandler.onForecastAdapterClick(mWeatherTextView.getText().toString());
        }
