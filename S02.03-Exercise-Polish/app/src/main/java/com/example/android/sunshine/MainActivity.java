...
public class MainActivity extends AppCompatActivity {
    ...
    //making one method to switch visibilities

    private void toggleWeatherDataview(boolean showWeatherData) {
        if(showWeatherData) {
