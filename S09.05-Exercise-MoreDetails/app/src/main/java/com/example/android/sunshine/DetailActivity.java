...
//  DONE (19) Create constant int values representing each column name's position above
    ...
    public static final int INDEX_WEATHER_WIND_DEG = 7;



//  DONE (20) Create a constant int to identify our loader used in DetailActivity
    private final int ID_DETAILS_LOADER = 38;
...
//      DONE (16) Use getData to get a reference to the URI passed with this Activity's Intent
        ...
        if (mUri == null)
            throw new NullPointerException("Null URI received by DetailsActivity!");
...
//          DONE (23) If the loader requested is our detail loader, return the appropriate CursorLoader
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == ID_DETAILS_LOADER) {
            return new CursorLoader(this,
                    mUri, DETAILS_PROJECTION, null, null, null);
        }
        return null;
    }
...
//      DOEN (33) Store a forecast summary in mForecastSummary
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        float windDegs = data.getFloat(INDEX_WEATHER_WIND_DEG);

        String dateString = SunshineDateUtils.getFriendlyDateString(this, dateInMillis, false);
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId);
        String highTempStr = SunshineWeatherUtils.formatTemperature(this, highInCelsius);
        String lowTempStr = SunshineWeatherUtils.formatTemperature(this, lowInCelsius);
        String humidityStr = String.format("%4.0f%%", humidity);
        String pressureStr = String.format("%4.0f hPa", pressure);
        String windStr = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDegs);

        mDateTextView.setText(dateString);
        mDescriptionTextView.setText(description);
        mHighTempTextView.setText(highTempStr);
        mLowTempTextView.setText(lowTempStr);
