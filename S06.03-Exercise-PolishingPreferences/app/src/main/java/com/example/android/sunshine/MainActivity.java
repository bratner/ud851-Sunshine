...
public class MainActivity extends AppCompatActivity implements
    ...
    private static boolean mPreferencesUpdate = false;
    ...
    // `O (7) In onStart, if preferences have been changed, refresh the data and set the flag to false

    @Override
    protected void onStart() {
        super.onStart();
        if (mPreferencesUpdate)
        {
            /* do something */
            /* ok, restart the loader */
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, null, this);
            mPreferencesUpdate = false;
        }
