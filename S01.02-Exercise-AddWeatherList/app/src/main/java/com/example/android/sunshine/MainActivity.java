...
public class MainActivity extends AppCompatActivity {
    ...
    // DONE Create a field to store the weather display TextView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] weatherList = { "Bad weather",
                "Good Weather", "Shitty weather", "Wonderful weather",
                "Sunny", "Rainy", "Cloudy", "Wonderfule",
